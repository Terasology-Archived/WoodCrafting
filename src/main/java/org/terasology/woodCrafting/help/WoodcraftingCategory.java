 ...
 */
package org.terasology.woodCrafting.help;
...
public class WoodcraftingCategory implements HelpCategory {
    private final String name = "Woodcrafting";
    ...
    public WoodcraftingCategory() {
    }

    public WoodcraftingCategory(ItemsCategoryInGameHelpRegistry itemsCategoryInGameHelpRegistry) {
