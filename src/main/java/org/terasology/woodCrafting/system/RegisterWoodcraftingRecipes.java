...
public class RegisterWoodcraftingRecipes extends BaseComponentSystem {
    ...
    public void initialise() {
        workstationRegistry.registerProcessFactory(Woodcrafting.BASIC_WOODCRAFTING_PROCESS_TYPE,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(Woodcrafting.BASIC_WOODCRAFTING_PROCESS,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(Woodcrafting.NOVICE_WOODCRAFTING_PROCESS_TYPE,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(Woodcrafting.NOVICE_WOODCRAFTING_PROCESS,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(Woodcrafting.ADVANCED_WOODCRAFTING_PROCESS_TYPE,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(Woodcrafting.ADVANCED_WOODCRAFTING_PROCESS,
                new CraftingWorkstationProcessFactory());
    ...
    private void addWoodPlankRecipes() {
        workstationRegistry.registerProcess(Woodcrafting.BASIC_WOODCRAFTING_PROCESS,
                new CraftingWorkstationProcess(Woodcrafting.BASIC_WOODCRAFTING_PROCESS, "Materials|Woodcrafting" +
                        ":WoodPlank",
                        new PlankRecipe(2), null, entityManager));

        workstationRegistry.registerProcess(Woodcrafting.ADVANCED_WOODCRAFTING_PROCESS,
                new CraftingWorkstationProcess(Woodcrafting.ADVANCED_WOODCRAFTING_PROCESS, "Materials|Woodcrafting" +
                        ":WoodPlank",
    ...
    private void addWorkstationFormingRecipes() {
        multiBlockFormRecipeRegistry.addMultiBlockFormItemRecipe(
                new UniformMultiBlockFormItemRecipe(new ToolTypeEntityFilter("axe"), new UseOnTopFilter(),
                        new StationTypeFilter("Woodcrafting:BasicWoodcraftingStation"), new Basic3DSizeFilter(2, 1, 1
                        , 1),
                        "Woodcrafting:BasicWoodcraftingStation",
                        new UniformBlockReplacementCallback<Void>(blockManager.getBlock("Woodcrafting" +
                                ":BasicWoodStation"))));
    }

    private void addStandardWoodWorkstationBlockShapeRecipes() {
        addPlankBlockRecipes();
        addWorkstationBlockShapesRecipe(Woodcrafting.ADVANCED_WOODCRAFTING_PROCESS, "Building|Fine " +
                        "Planks|Woodcrafting:FinePlankBlock",
    ...
    private void addShapeRecipe(String processType, String recipeNamePrefix, String ingredient,
        ...
        workstationRegistry.registerProcess(processType, new CraftingWorkstationProcess(processType,
                recipeNamePrefix + shape, shapeRecipe, null, entityManager));
    }
    ...
    private void addWorkstationBlockShapesRecipe(String processType, String recipeNamePrefix, String ingredient,
        ...
        workstationRegistry.registerProcess(processType, new CraftingWorkstationProcess(processType, recipeNamePrefix
                , fullBlockRecipe, null, entityManager));
