 ...
 */
package org.terasology.woodCrafting.generator;
...
@RegisterWorldGenerator(id = "neoTTA", displayName = "Neo Throughout the Ages", description = "Generates the world for playing 'NeoTTA' content mods. This will be moved to the NeoTTA module.")
public class NeoTTAWorldGenerator extends PluggableWorldGenerator {
